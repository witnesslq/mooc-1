...
/**
 * @author: wuke 
 * @date  : 2016年11月9日 下午5:29:39
 * Title  : FrequentPattern
 * Description : 
 */
public class _Apriori2  
{  
	...
	public static void main(String[] args) {
		...
		_Apriori2 apriori2 = new _Apriori2();
    ...
    {  
        ...
        System.out.println("*********候选频繁一项集********");
        for(Map.Entry<String, Integer> entry : resultSetMap.entrySet()) {
